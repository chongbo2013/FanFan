...
import static com.fanfan.novel.utils.system.AppUtil.resArray;
import static com.fanfan.novel.utils.system.AppUtil.valueForArray;

public class XFSetActivity extends BarBaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public static void newInstance(Activity context) {
        Intent intent = new Intent(context, XFSetActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_xf_set;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.line_hear_layout:
                DialogUtils.showLongListDialog(XFSetActivity.this, "选择在线监听语言", R.array.line_iat_language_show, new MaterialDialog.ListCallback() {
                    @Override
            ...
            case R.id.line_talker_layout:
                DialogUtils.showLongListDialog(XFSetActivity.this, "选择在线发言人", R.array.line_talker_show,
                        new MaterialDialog.ListCallback() {
                            ...
                            public void onSelection(MaterialDialog dialog, View itemView, final int position, CharSequence text) {
                                if (position > 1 && position < 5) {//2,3,4时，纯英文 2, 3, 4, 20, 21, 22, 23, 24
                                    ...
                                    DialogUtils.showMultiChoiceDisabledItems(XFSetActivity.this, "选择中英文", R.array.line_tts_language_show,
            ...
            case R.id.local_talker_layout:
                DialogUtils.showLongListDialog(XFSetActivity.this, "选择离线发言人", R.array.local_talker_show, new MaterialDialog.ListCallback() {
                    @Override
                    public void onSelection(MaterialDialog dialog, View itemView, int position, CharSequence text) {
